...
Quick and simple AI upscaling node using tiled processing for memory efficiency. Select an upscale model from your upscale_models directory. Adjust tile size based on VRAM - smaller tiles use less memory. Increase overlap to reduce visible seams between tiles.
