...
class TT_FluxWorkflowSettingsAdvanced:
    ...
    def get_settings(self, seed, steps, cfg, sampler_name, scheduler, guidance, clip_l_positive, t5xxl_positive,
                     clip_l_negative, t5xxl_negative):
        workflow_config = {
            "seed": seed,
            "steps": steps,
            "cfg": cfg,
        ...
        return (workflow_config, seed, steps, cfg, sampler_name, scheduler, guidance,
                clip_l_positive, t5xxl_positive, clip_l_negative, t5xxl_negative)
