    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input("upscale_mode", options=RESIZE_METHODS, advanced=True),
    ...
    def define_schema(cls) -> io.Schema:
        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input("upscale_mode", display_name="grain_upscale_mode", options=RESIZE_METHODS, advanced=True),
