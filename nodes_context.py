...
class TTContext():
    ...
    """
    ascore_negative: io.Float | None = None
    ascore_positive: io.Float | None = None
    cfg: io.Float | None = None
    clip: io.Clip | None = None
    clip_g_negative: io.String | None = None
    clip_g_positive: io.String | None = None
    clip_l_negative: io.String | None = None
    clip_l_positive: io.String | None = None
    ...
    t5xxl_negative: io.String | None = None
    t5xxl_positive: io.String | None = None
    target_height: io.Int | None = None
    target_width: io.Int | None = None
    vae: io.Vae | None = None
    width: io.Int | None = None
...
class ContextNode(io.ComfyNode):
    ...
    @classmethod
    def outputs(cls) -> list[io.Output]:
        output_schema = []
